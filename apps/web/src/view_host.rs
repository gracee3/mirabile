                                ...
                                {scene.map_or_else(
                                    ...
                                    |scene| view! {
                                        <WheelScene
                                            ...
                                            description="A semantic astrology wheel showing zodiac signs, calculated houses and angles, true point anchors with formatted labels, and calculated aspects."
                                        />
                                    }.into_any(),
                                )}
