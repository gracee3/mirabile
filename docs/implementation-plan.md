...
5. Prove the architecture in `mirabile-web`: a source chart flows through calculation, analysis, layout, and SVG; an AspectSet draft previews immediately and saves or cancels without mutating canonical state prematurely.
