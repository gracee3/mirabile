...
use crate::{
    AyanamsaConfiguration, BackendDescriptor, CalcKey, CalculationBackendResult,
    CalculationContext, CalculationProvenance, CelestialPositionsRequest, DerivedFormula,
    DerivedPointRequest, DerivedPointsRequest, HouseCalculationRequest, ImplementationIdentity,
    KeyError, MirabileCalculationProvenance, NumericLocation, ResolvedCalculationRequest,
...
impl CalculationEngine {
    ...
    pub fn prepare(
        ...
        let houses = (calculation.houses != mirabile_core::HouseSystem::NoHouses).then(|| {
    ...
    pub fn complete(
        ...
        Ok(CalculationValue {
            ...
            provenance: CalculationProvenance {
                mirabile: MirabileCalculationProvenance {
...
fn resolve_requested_points(
    displayed: &PointSet,
    aspected: &PointSet,
    fortune_formula: mirabile_core::FortuneFormula,
...
fn resolve_time(
    ...
    Ok(ResolvedTime {
        instant: mirabile_core::AstroInstant::from_julian_day(julian_day)
            .map_err(|_| TimeResolutionError::NonFiniteInstant)?,
        scale: mirabile_core::TimeScale::Utc,
...
pub enum CalculationError {
    ...
    RecordMismatch {
        expected: mirabile_core::ResourceId,
        actual: mirabile_core::ResourceId,
    },
