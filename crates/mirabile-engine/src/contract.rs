...
pub struct CalculationContext {
    ...
    pub location: Option<NumericLocation>,
}

#[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
pub struct NumericLocation {
    pub latitude: mirabile_core::Latitude,
    pub longitude: mirabile_core::Longitude,
}

/// Provider-neutral zodiac semantics after Mirabile resolves `CalculationSpec`.
...
/// Mirabile-owned ayanamsa identity and optional deterministic configuration.
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct MirabileCalculationProvenance {
...
pub struct CalculationProvenance {
    pub mirabile: MirabileCalculationProvenance,
    pub backend: ImplementationIdentity,
    pub time: Option<TimeScaleConversionProvenance>,
    pub celestial: CelestialCalculationProvenance,
    pub houses: Option<HouseCalculationProvenance>,
