...
impl DeterministicBackend {
    pub const ID: &'static str = "astra-deterministic-demo";
    ...
    fn model() -> EphemerisModelIdentity {
        EphemerisModelIdentity {
            ...
            id: "astra-demo-linear-model".into(),
            version: Some("1".into()),
            revision: None,
...
impl CalculationBackend for DeterministicBackend {
    fn descriptor(&self) -> BackendDescriptor {
        ...
        let celestial = Self::implementation("astra-deterministic-celestial");
        let houses = Self::implementation("astra-deterministic-houses");
        BackendDescriptor {
